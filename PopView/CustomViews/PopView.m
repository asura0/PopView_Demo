...
- (void)initConfgureCenterView{
    ...
    if (self.popViewType == PopViewPasswordType) {
        ...
        //普通
        contentLabel = [self addSubViwLableWithFrame:CGRectMake(kScreenSpacing, CGRectGetMaxY(titleLabel.frame), selfWidth - kScreenSpacing * 2, selfHeight / 3) title:self.content sizeFont:14 isTitle:NO];
